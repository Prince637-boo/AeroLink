...
**Note** : Ce projet est actuellement en développement actif. La structure de base est en place, mais de nombreuses fonctionnalités restent à implémenter selon le plan défini dans `docs/shéma.md`.votre aide me sera d'une grande qide
